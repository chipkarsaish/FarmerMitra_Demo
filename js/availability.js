...
function createCropCard(crop) {
    ...
    if (crop.sustainable) sustainabilityTags.push('<span class="sustainability-tag"><i class="fa-solid fa-seedling"></i> Eco-friendly</span>');
...
function createEquipmentCard(equipment) {
    ...
    card.innerHTML = `
        ...
        <div class="resource-body">
            ...
            ${equipment.sustainable ? '<div class="sustainability-tags"><span class="sustainability-tag"><i class="fa-solid fa-seedling"></i> Eco-friendly</span></div>' : ''}
            <div class="resource-actions">
...
function createInputCard(input) {
    ...
    if (input.sustainable) sustainabilityTags.push('<span class="sustainability-tag"><i class="fa-solid fa-seedling"></i> Eco-friendly</span>');
