    ...
    amenities: [
        {
            ...
            status: 'completed',
            paymentMode: 'Cash',
            module: '<i class="fa-solid fa-toolbox"></i>',
            basePrice: 1500,
            discount: 150,
            carbonUsed: 50,
    ...
    crops: [
        {
            ...
            module: '<i class="fa-solid fa-wheat-awn"></i>',
            buyer: 'Buyer #1234',
    ...
    payments: [
        {
            ...
            status: 'completed',
            paymentMode: 'Bank Transfer',
            module: '<i class="fa-solid fa-sack-dollar"></i>',
            loanType: 'Crop Loan',
    ...
    carbon: [
        {
            ...
            status: 'completed',
            paymentMode: 'N/A',
            module: '<i class="fa-solid fa-seedling"></i>',
    ...
    return `
        <div class="order-card">
            ...
            <div class="order-extra">
                ...
                <div class="extra-item">
                    <span class="extra-icon"><i class="fa-solid fa-credit-card"></i></span>
                    <span>${order.paymentMode}</span>
                </div>
            </div>
            <div class="order-actions">
                <button class="btn btn-outline btn-small view-details-btn" data-order-id="${order.id}">View Details</button>
                <button class="btn btn-outline btn-small"><i class="fa-solid fa-file"></i> Receipt</button>
            </div>
        </div>
    `;
}
...
function handleNotifications() {
    alert('Notifications:\n\n🔔 Rental return due tomorrow - Tractor\n<i class="fa-solid fa-sack-dollar"></i> Payment due in 3 days - ₹5,000\n<i class="fa-solid fa-circle-check"></i> Settlement completed - Rice sale');
}

// Handle User Menu
function handleUserMenu() {
    alert('User Menu:\n\n<i class="fa-solid fa-user"></i> Profile\n⚙️ Settings\n<i class="fa-solid fa-chart-pie"></i> My Activity\n<i class="fa-solid fa-right-from-bracket"></i> Logout');
}
